...
public class StreamStatisticsComparison{
	...
	public static void main( String[] args ){
		...
		System.out.printf("Total time in milliseconds: %d\n\n", 
			Duration.between(separateStart, separateEnd).toMillis());
		
		LongStream stream1 = Arrays.stream(values);
		System.out.println("Clculating statistics on sequential stream");
		...
		System.out.printf("Calculating statistics on parallel stream");
	...
	public static void displayStatistics( LongSummaryStatistics stats ){
