...
import br.com.diagnosticit.api.BackgroundCalculator;
...
public class FibonacciNumbers extends JFrame{
	...
	public FibonacciNumbers(){
		...
		goJButton.addActionListener( event -> {
			int n;
			try{
		...
		eventThreadJPanel.setBorder(
			new TitledBorder(new LineBorder(Color.BLACK), "Without SwingWorker"));
		eventThreadJPanel.add(nJLabel);
		eventThreadJPanel.add(nFibonacciJLabel);
		nextNumberJButton.addActionListener( event -> {
				long temp = n1 + n2;
				n1 = n2;
				n2 = temp;
				++count;
