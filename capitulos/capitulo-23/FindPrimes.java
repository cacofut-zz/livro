...
import br.com.diagnosticit.api.PrimeCalculator;
...
public class FindPrimes extends JFrame{
	...
	public FindPrimes(){
		...
		getPrimesJButton.addActionListener( event -> {
			...
			calculator.addPropertyChangeListener( e -> {
		...
		cancelJButton.addActionListener( event -> calculator.cancel(true) );
